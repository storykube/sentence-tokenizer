...
s = s.set("If you're a plant lover: this guide is just for you. ##In fact, we're going to find out together how to "
          ...
          "sentence is blah blah: is it works? Also, this is a dot.With something attached. This is a no.12 is it "
          "working? For example now, this is 10 years ago. Now instead, we will meet on ago 12th. How are you dr. Jean?")
